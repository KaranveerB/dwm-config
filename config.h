...
static const char *fonts[]          = { "DejaVu Sans:size=9:antialias=true:autohint=true", "Hack Nerd Font:size=9:antialias=true:autohint=true" };
static const char dmenufont[]       = "Source Code Pro Medmium:size=9:antialias=true:autohint=true";
